...
import { initPanelZoom, initGyroLook, revealSala, createTourProgress, unlockAudios, mostrarErrorFatal, initDebugConsole, setPanelImagen, precargarVecinas, precargarTodas } from './museo/usabilidad.js'
...
function enterZoom(artwork, mesh) {
  ...
  precargarVecinas(meshes, zoomIndex, 'posts')
...
function showPaintingPanel(artwork) {
  ...
  setPanelImagen(panelImage, `/posts/full/${encodeURI(base)}.webp`)
...
function enterMuseum() {
  ...
  precargarTodas(engine.paintingMeshes, 'posts')
}
